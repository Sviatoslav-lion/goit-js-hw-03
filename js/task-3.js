...
function filterArray(numbers, value) {
    ...
    // створемо цикл для перебору масиву numbers
    for (let i = 0; i < numbers.length; i++){ 
        // якщо число в масиві більше value
        if (numbers[i] > value) {
            newArray.push(numbers[i]); // тоді додаємо це число в новий масив
        }
    }
    return newArray; // повертаємо масив з числами більше за value
